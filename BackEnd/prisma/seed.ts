  ...
  const products = [
    {
      ...
      colors: ['Negro', 'Blanco'],
      featured: true,
      images: ['/uploads/producto1.jpg', '/uploads/block-1.jpg'],
    },
    {
    ...
    {
      name: 'Mochila Explorer - Explorer',
      description: 'Mochila de 25L resistente al agua.',
      price: 59,
      stock: 20,
      category: 'Accesorios',
